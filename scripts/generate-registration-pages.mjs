...
const programs = [
  {
    ...
    faqs: [
      ...
      ['Berapa maksimal peserta per kelas?', 'Maksimal 10 siswa per kelas agar suasana tetap hidup, tetapi feedback dari tutor tetap personal.'],
    ],
    schedules: [
...
${stagePicker}
          ...
          <p class="form-note">
            Dengan mendaftar, kamu setuju dengan <a href="syarat-ketentuan.html">syarat & ketentuan</a> Elevaree.Academy.<br>
